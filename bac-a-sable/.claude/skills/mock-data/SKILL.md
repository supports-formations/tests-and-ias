---
name: mock-data
description: Generate realistic mock data for testing using factories, fixtures, and Faker.js. Use whenever the user mentions mock, mocking, mocked data, fake data, test data, données de test, or données mockées — for seeding test databases, creating test fixtures/factories, mocking API responses, or writing/generating any mock generator function (e.g. generateMock*, *Factory, *Fixture).
...
Trigger this skill BEFORE writing any mock/fixture/factory code by hand, whenever the request involves:

- The words "mock", "mocker", "données de test", "données mockées", "fixtures", "factory/factories" (FR or EN)
...
- Writing a function named like `generateMock*`, `createMock*`, `*Factory`, `*Fixtures`, or extending an existing one
